...
class LossStatistics:
    ...
    def process(self, save_dir):
        ...
        # Print statistics
        logging.info("Training losses: Mean = {:.4f}, Variance = {:.4f}, Max = {:.4f}".format(losses_mean, losses_var, losses_max))
        logging.info("Validation losses: Mean = {:.4f}, Variance = {:.4f}, Max = {:.4f}".format(val_losses_mean, val_losses_var, val_losses_max))
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(save_dir, "figure_loss_distribution.png"))
        plt.close()
